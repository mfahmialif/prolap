...
@section('title', 'Admin | Komponen Nilai')
@section('css')
@endsection
@section('content')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Komponen Nilai</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">/ Komponen Nilai
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Komponen Nilai </h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control"
                                    placeholder="Masukkan Nama Komponen Nilai" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="bobot">Bobot</label>
                                <input type="number" name="bobot" class="form-control"
                                    placeholder="Masukkan Bobot Komponen Nilai" required autocomplete="off">
                            </div>
                        </div>
...
@push('script')
    ...
    <script>
        ...
        $('#form_add').submit(function(e) {
            ...
            var url = "{{ route('admin.komponen-nilai.add') }}";
        ...
        $('#modal_edit').on('show.bs.modal', function(event) {
            ...
            modal.find('#nama').val(nama).change();
            modal.find('#bobot').val(bobot);
        })

        $('#form_edit').submit(function(e) {
            e.preventDefault();
            var url = "{{ route('admin.komponen-nilai.edit') }}";
    ...
    <script>
        function deleteData(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('admin.komponen-nilai.delete') }}";
        ...
        function dataTable(id) {
            var url = "{{ route('admin.komponen-nilai.data') }}"
