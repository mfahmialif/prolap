                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">/ Biaya
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4 w-100" name="jenjang" required>
                                    ...
                                    @foreach (\Helper::getEnumValues('prodi', 'jenjang') as $item)
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah" class="form-control"
                                    placeholder="Masukkan Jumlah Biaya" onkeyup="formatRupiah(this.value,'#jumlahHelp')"
                                    onfocus="this.select();" required autocomplete="off">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="jenjang">Jenjang</label>
                                <select class="form-control select2bs4 w-100" id="jenjang" name="jenjang" required>
                                    <option value="">Pilih Jenjang</option>
                                    @foreach (\Helper::getEnumValues('prodi', 'jenjang') as $item)
                                        <option value="{{ $item }}">{{ $item }}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah" id="jumlah" class="form-control"
                                    placeholder="Masukkan Jumlah Biaya" onkeyup="formatRupiah(this.value,'#jumlahHelpEdit')"
                                    onfocus="this.select();" required autocomplete="off">
...
@push('script')
    ...
    <script>
        ...
        $('#form_edit').submit(function(e) {
            ...
            var url = "{{ route('admin.biaya.edit') }}";
    ...
    <script>
        function deleteData(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('admin.biaya.delete') }}";
        ...
        function dataTable(id) {
            var url = "{{ route('admin.biaya.data') }}"
