...
@section('title', 'Admin | Penilaian Peserta')
@section('css')
    <style>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.penilaian.peserta.filter')
                        ...
                        <div class="card" id="card">
                            ...
                            <div class="card-body" id="card_body">
                                @include('components.admin.table', [
                                    'table' => 'table1',
                                    'cardId' => 'card',
                                    'url' => route('admin.penilaian.peserta.data'),
                                    'header' => ['No', 'NIM', 'Nama', 'Prodi', 'Jenis Kelamin', 'Aksi'],
                                    'columns' => [
                                        [
                                            'data' => 'id',
                                            'name' => 'id',
                                    ...
                                    'filter' => ['jenis_kelamin', 'prodi_id', 'tahun_id'],
                                ])
                            </div>
                            <!-- /.card-body -->
                        </div>
