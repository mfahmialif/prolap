...
@section('title', 'Admin | Dokumen Wajib Dpl')
@section('css')
    <style>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Dokumen Wajib {{ @$pengawas ? 'Pengawas' : 'DPL' }} <b>{{ @$dpl->nama }}{{ @$pengawas->nama }}</b></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.dokumen-wajib.dpl.filter')
...
@push('script')
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.dokumen-wajib.dpl.data') }}"
