...
@section('content')
    ...
    @if (isset($dpl) == false && isset($pengawas) == false)
        @include('admin.posko.add')
        @include('admin.posko.edit')
...
@push('script')
    ...
    <script>
        function deleteData(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('admin.posko.delete') }}";
        ...
        function dataTable(id) {
            var url = "{{ route('admin.posko.data') }}"
