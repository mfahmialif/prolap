    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Absensi Pamong <b>{{ @$pamong->nama }}</b></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.absensi.pamong.filter')
...
@push('script')
    ...
    <script>
        $(document).on('click', '.BtnRekap', function() {
            let id = $(this).data('id');
            location.href = "{{ route('admin.absensi.pamong') }}" + '/detail/'  + id;
        });

        $(document).on('click', '.BtnInput', function() {
            let id = $(this).data('id');
            location.href = "{{ route('admin.absensi.pamong') }}" + '/input/' + id;
        });
    </script>
    <script>
        $("#form_submit").click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.absensi.pamong.store') }}",
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.absensi.pamong.data') }}"
