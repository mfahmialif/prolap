        ...
        <div class="content">
            <div class="container-fluid">
                <form action="javascript:void(0)" id="form_input_absensi" method="POST">
                    {{-- <form action="{{ route('admin.absensi.pamong.input.simpan', ['idPamong' => $idPamong]) }}" id="form_input_absensi" method="POST"> --}}
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-primary" role="alert">
                                Input Absensi Untuk pamong {{ $pamong->nama }}
                            </div>
                                            ...
                                            <div class="form-group">
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="pertemuan" class="form-control"
                                                            autocomplete="off" required id="pertemuan"></td>
                                                </tr>
                                            </div>
                                        </tbody>
                                    </table>
...
@push('script')
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.absensi.pamong.input.data', ['idPamong' => $idPamong]) }}"
    ...
    <script>
        $(".BtnSimpanDetail").click(function(e) {
            e.preventDefault();
            $.ajax({
                type: "POST",
                url: "{{ route('admin.absensi.pamong.input.simpan', ['idPamong' => $idPamong]) }}",
                data: $("#form_input_absensi").serialize(),
                dataType: "json",
                beforeSend: function() {
