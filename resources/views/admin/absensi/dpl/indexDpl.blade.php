...
@section('title', 'Admin | Absensi Dpl')
@section('css')
    <style>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Absensi DPL <b>{{ @$dpl->nama }}</b></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.absensi.dpl.filterDpl')

                <div class="d-flex justify-content-end mb-3">
                    <a href="{{ route('admin.absensi.downloadExcel.dpl') }}" class="btn btn-success"><i class="fas fa-file-export"></i> Download Excel</a>
                </div>
...
@push('script')
    ...
    <script>
        $(document).on('click', '.BtnRekap', function() {
            let id = $(this).data('id');
            location.href = "{{ route('admin.absensi.dpl') }}" + '/detail/' + id;

        });
        $(document).on('click', '.BtnInput', function() {
            let poskoId = $(this).data('posko_id');
            let idPoskoDpl = $(this).data('id');
            let idDpl = $(this).data('dpl_id');
            location.href = "{{ route('admin.absensi.dpl') }}" + '/input/' + idPoskoDpl;
        });
    </script>
    ...
    <script>
        ...
        function dataTable(id) {
            var url = "{{ route('admin.absensi.data.dpl') }}"
