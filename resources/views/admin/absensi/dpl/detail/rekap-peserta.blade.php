        ...
        <div class="card card-outline card-primary" id="card_peserta">
            ...
            <div class="card-body" id="card_body_peserta">
                <div class="table-responsive">
                    <table id="table_absensi_dpl_rekap" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
...
@push('script')
    <script>
        $(document).ready(function() {
            $(document).ready(function() {
                ...
                var table1 = dataTablePeserta('#table_absensi_dpl_rekap');
    ...
    <script>
        function dataTablePeserta(id) {
            var url = "{{ route('admin.absensi.detail.dataPeserta', ['idPoskoDpl' => $idPoskoDpl]) }}"
