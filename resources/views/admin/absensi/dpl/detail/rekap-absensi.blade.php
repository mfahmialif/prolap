    ...
    <div class="col-12">
        <div class="card" id="card">
            <div class="card-header">
                <a href="{{ route('admin.absensi.input', ['idPoskoDpl' => $idPoskoDpl]) }}"
...
@push('script')
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.absensi.detail.data', ['idPoskoDpl' => $idPoskoDpl]) }}"
    ...
    <script>
        $(document).on('click', ".BtnRekap", function() {
            var id = $(this).data('id');
            var posko_dpl_id = $(this).data('posko_dpl_id');
            location.href = posko_dpl_id + "/edit/" + id;
        });
        $(document).on('click', '.BtnDel', function() {
            var baseUrl =
                "{{ route('admin.absensi.detail.delete', ['idPoskoDpl' => 'PLACEHOLDER_ID', 'no' => 'PLACEHOLDER_POST_ID']) }}";
            let id = $(this).data('id');
            let nama = $(this).data('nama');
            let posko_dpl_id = $(this).data('posko_dpl_id');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = baseUrl
                        .replace('PLACEHOLDER_ID', posko_dpl_id)
