        ...
        <div class="content">
            <div class="container-fluid">
                <form action="javascript:void(0)" id="form_input_absensi" method="POST">
                    {{-- <form action="{{ route('admin.absensi.input.simpandetail', ['idPoskoDpl' => $idPoskoDpl]) }}" id="form_input_absensi" method="POST"> --}}
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card" id="card">
                                ...
                                <div class="card-body" id="card_body">
                                    <div class="table-responsive">
                                        <table id="table_absensi_dpl_detail"
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            var table1 = dataTable('#table_absensi_dpl_detail');
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.absensi.input.inputDetail', ['idPoskoDpl' => $idPoskoDpl]) }}"
    ...
    <script>
        $('#form_input_absensi').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.absensi.input.simpandetail', ['idPoskoDpl' => $idPoskoDpl]) }}",
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
