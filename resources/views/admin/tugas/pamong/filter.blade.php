...
<div class="row">
    <div class="col-12">
        <form action="{{ route('admin.penugasan.pamong.data') }}" method="POST" target="_blank">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <select class="form-control select2bs4 w-100 jk" id="tahun_id" name="tahun_id" required>
