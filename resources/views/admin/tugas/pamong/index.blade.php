...
@section('title', 'Admin | Penugasan Pamong')
@section('css')
    <style>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Penugasan Pamong <b>{{ @$pamong->nama }}</b></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.tugas.pamong.filter')
...
@push('script')
    ...
    <script>
        $(document).on('click', '.BtnRekap', function() {
            let id = $(this).data('id');
            location.href = "{{ route('admin.penugasan.pamong.index') }}" + '/detail/' + id;
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.penugasan.pamong.data') }}"
