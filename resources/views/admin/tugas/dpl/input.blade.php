...
@section('title', 'Admin | Input Penugasan DPL')
@section('content')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Input Penugasan DPL</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">Penugasan</li>
                            <li class="breadcrumb-item">DPL</li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-primary" role="alert">
                            Input Penugasan dari Dpl {{ $posko->nama_dpl }}
                        </div>
                        <div class="alert alert-success" role="alert">
                            Silahkan input penugasan yang diberikan oleh Dpl
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $PenugasanDpl->penugasan }}</td>
                                        </tr>
                                        {{-- <tr>
                                            <th scope="row">Mulai</th>
                                            <td><span class="badge badge-success">{{ $PenugasanDpl->mulai }}</span></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Sampai</th>
                                            <td><span class="badge badge-danger">{{ $PenugasanDpl->selesai }}</span></td>
                                        </tr> --}}
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" id="card-refresh-content">
                                @foreach ($data2 as $item)
                                    @php
                                        $data = App\Models\PenugasanDplDetail::where('posko_peserta_id', $item->id)
...
@push('script')
    ...
    <script>
        $('#form_update_dokumen').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.penugasan.detail.input.simpan', ['idPoskoDpl' => $idPoskoDpl, 'idPenugasanDpl' => $idPenugasanDpl]) }}",
                data: fd,
                contentType: false,
                processData: false,
                beforeSend: function() {
        ...
        function deleteData(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url =
                        "{{ route('admin.penugasan.detail.input.delete', ['idPoskoDpl' => $idPoskoDpl, 'idPenugasanDpl' => $idPenugasanDpl]) }}";
