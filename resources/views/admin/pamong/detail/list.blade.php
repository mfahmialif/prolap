        ...
        <div class="timeline">
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">Peserta</a> Informasi Peserta</h3>
                    <div class="timeline-body">
                        Silahkan klik tombol Peserta untuk menuju informasi Peserta
                    </div>
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pamong.detailPeserta', ['pamong' => $pamong]) }}"
            ...
            {{-- <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pamong.detailAbsensi', ['pamong' => $pamong]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pamong.detailPenugasan', ['pamong' => $pamong]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pamong.detailPenilaian', ['pamong' => $pamong]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pamong.detailMonitoring', ['pamong' => $pamong]) }}"
