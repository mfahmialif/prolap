...
@section('title', 'Admin | Jurnal Pengawas')
@section('css')
    <style>
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex flex-row">
                        <h1>Jurnal {{ @$pengawas ? 'Pengawas' : 'Pengawas' }} <b>{{ @$dpl->nama }}{{ @$pengawas->nama }}</b></h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                {{-- FILTER --}}
                @include('admin.jurnal.pengawas.filter')
...
@push('script')
    ...
    <script>
        function dataTable(id) {
            var url = "{{ route('admin.jurnal.pengawas.data') }}"
