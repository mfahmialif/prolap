        ...
        <div class="timeline">
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pengawas.detailPosko', ['pengawas' => $pengawas]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pengawas.detailAbsensi', ['pengawas' => $pengawas]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    <span class="time"><i class="fas fa-check"></i></span>
                    <h3 class="timeline-header"><a href="#">Jurnal Kegiatan</a> Mahasiswa</h3>
                    <div class="timeline-body">
                        Silahkan klik tombol Jurnal Kegiatan Mahasiswa untuk menuju informasi Jurnal Kegiatan Mahasiswa
                    </div>
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pengawas.detailJurnal', ['pengawas' => $pengawas]) }}"
                            class="btn btn-primary btn-sm">Jurnal Kegiatan Mahasiswa</a>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pengawas.detailPenugasan', ['pengawas' => $pengawas]) }}"
            ...
            <div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-footer">
                        <a href="{{ route('admin.pengawas.detailMonitoring', ['pengawas' => $pengawas]) }}"
