                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @include('components.admin.pengawas.form', ['param' => 'add'])
                        </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            @include('components.admin.pengawas.form', ['param' => 'edit'])
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
...
@push('script')
    ...
    <script>
        ...
        $('#form_add').submit(function(e) {
            ...
            var url = "{{ route('admin.pengawas.add') }}";
        ...
        $('#modal_edit').on('show.bs.modal', function(event) {
            ...
            modal.find('#hp_edit').val(hp);
            modal.find('#email_edit').val(email);
            modal.find('#jenis_kelamin_edit').val(jenis_kelamin).change();
        })

        $('#form_edit').submit(function(e) {
            e.preventDefault();

            var url = "{{ route('admin.pengawas.edit') }}";
    ...
    <script>
        function deleteData(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('admin.pengawas.delete') }}";
        ...
        function dataTable(id) {
            var url = "{{ route('admin.pengawas.data') }}"
